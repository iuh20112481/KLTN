...
<head>
    ...
    <title>Đăng nhập tài khoản nhân sự</title>
...
<div class="container">
        ...
        <div class="container">
            <br>
            <div class="row">
                <div class="col-md-6 ms-md-3 align-items-end">
                <h1 id="h1" style="background:linear-gradient(to right, #007FFF, #ffc700); -webkit-background-clip: text; color: transparent; font-size: 3em; padding:3px; ">HPship XIN CHÀO CỘNG SỰ !</h1>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col" style="margin-top: 60px;">
            <img src="../img/vechungtoi13.avif" class="img-fluid" alt="...">
        </div>
